...
import { AUTO_CONFIG_VIEW } from './auto-config.mock';

/**
 * W-13 — Configuración automática sugerida (Detección automática).
 *
 ...
 */
@Component({
  selector: 'tc-auto-config',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [ReactiveFormsModule, BackLink, Button, Icon, StatusBadge],
  templateUrl: './auto-config.html',
  styleUrl: './auto-config.scss',
})
export default class AutoConfig {
  private readonly fb = inject(FormBuilder);

  protected readonly view = AUTO_CONFIG_VIEW;
